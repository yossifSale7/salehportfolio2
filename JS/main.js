loading = document.querySelector(".overlay")
...
let text = document.querySelector(".main .portfolio-section .portfolio-text h1")

let text2 = document.querySelector(".main .portfolio-section .portfolio-text p")

let portfolio = document.querySelector(".main .portfolio-section .portfolio-section-imgs")
...
document.addEventListener('DOMContentLoaded', function() {  
    ...
    setTimeout (() => {
        ...
        portfolio.style.marginTop = '30px';
